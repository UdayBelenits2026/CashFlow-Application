...
@Component({
  ...
  template: `
    <div class="module-page">
      <div class="module-header">
        ...
        <p class="module-subtitle">Set category thresholds, limits, and budget targets</p>
      </div>
      <div class="module-card">
        <div class="placeholder-content">
          <i class="fa-solid fa-calendar-days module-icon"></i>
          <h2>{{ title }} Module</h2>
          <p>Monthly envelopes, spending limits, and category budgets will be configured here.</p>
        </div>
      </div>
    </div>
  `,
  styles: [`
    ...
    .module-icon { font-size: 2.5rem; color: #f59e0b; margin-bottom: 1rem; }
