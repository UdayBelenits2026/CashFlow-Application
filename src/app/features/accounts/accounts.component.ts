...
@Component({
  ...
  template: `
    <div class="module-page">
      <div class="module-header">
        ...
        <p class="module-subtitle">Manage connected banks, credit cards, and wallets</p>
      </div>
      <div class="module-card">
        <div class="placeholder-content">
          <i class="fa-solid fa-building-columns module-icon"></i>
          <h2>{{ title }} Module</h2>
          <p>Bank balances, credit card limits, and wallet connections will be shown here.</p>
        </div>
      </div>
    </div>
  `,
  styles: [`
    ...
    .module-icon { font-size: 2.5rem; color: #0ea5e9; margin-bottom: 1rem; }
