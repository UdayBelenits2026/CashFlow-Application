...
@Component({
  ...
  template: `
    <div class="module-page">
      <div class="module-header">
        ...
        <p class="module-subtitle">Analyze inflow vs outflow and cash trajectory</p>
      </div>
      <div class="module-card">
        <div class="placeholder-content">
          <i class="fa-solid fa-circle-dollar-to-slot module-icon"></i>
          <h2>{{ title }} Module</h2>
          <p>Cash flow projections, runway estimation, and liquidity charts will be shown here.</p>
        </div>
      </div>
    </div>
  `,
  styles: [`
    ...
    .module-icon { font-size: 2.5rem; color: #6366f1; margin-bottom: 1rem; }
