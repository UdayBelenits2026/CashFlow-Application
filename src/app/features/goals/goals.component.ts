...
@Component({
  ...
  template: `
    <div class="module-page">
      <div class="module-header">
        ...
        <p class="module-subtitle">Track savings targets, milestones, and financial ambitions</p>
      </div>
      <div class="module-card">
        <div class="placeholder-content">
          <i class="fa-solid fa-bullseye module-icon"></i>
          <h2>{{ title }} Module</h2>
          <p>Emergency funds, vacation savings, and investment milestones will appear here.</p>
        </div>
      </div>
    </div>
  `,
  styles: [`
    ...
    .module-icon { font-size: 2.5rem; color: #ec4899; margin-bottom: 1rem; }
